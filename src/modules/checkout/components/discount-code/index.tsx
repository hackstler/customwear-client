      ...
      <div className="txt-medium">
        {gift_cards.length > 0 && (
          <div className="flex flex-col mb-4">
            <Heading className="txt-medium">Tarjeta(s) de regalo aplicadas:</Heading>
            {gift_cards?.map((gc) => (
              <div
        ...
        {appliedDiscount ? (
          ...
          <form action={formAction} className="w-full">
            <Label className="flex gap-x-1 my-2 items-center">
              ...
              >
                Añadir tarjeta regalo o código de descuento
              </button>
              ...
              <>
                <div className="flex w-full gap-x-2 items-center">
                  <Input
                    ...
                    autoFocus={false}
                  />
                  <SubmitButton variant="secondary" className="mt-6 px-4 py-2 rounded-md bg-black text-white hover:bg-gray-800">Aplicar</SubmitButton>
                </div>
