      ...
      <div className="grid grid-cols-1 gap-y-8">
        ...
        <div className="flex items-start gap-x-2">
          ...
          <div>
            ...
            <p className="max-w-sm">
              ¿El ajuste no es del todo correcto? No te preocupes, te cambiaremos tu
        ...
        <div className="flex items-start gap-x-2">
          ...
          <div>
            ...
            <p className="max-w-sm">
              Simplemente devuelva su producto y le reembolsaremos su dinero, haremos todo lo posible para asegurarnos de que su devolución
